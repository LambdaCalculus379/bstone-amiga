...
// BBi
//#define vga_ref_width 320
//#define vga_ref_height 200
#define vga_width 320
//#define vga_width viewwidth
...
void VL_DrawPicBare (int16_t x, int16_t y, byte far *pic, int16_t width, int16_t height);
...
void VL_SizePropString (char *str, int16_t *width, int16_t *height, char far *font);

// BBi
#define vl_get_offset(base_offset, x, y) ((4 * (base_offset)) + ((y) * vga_width) + (x))
#define vl_get_pixel(base_offset, x, y) (vga_memory[vl_get_offset((base_offset), (x), (y))])
