...
//
///////////////////////////////////////////////////////////////////////////
int16_t US_CheckParm(char far *parm,char far * far * strings)
{
	char	cp,cs,
			far *p,far *s;
	int		i;
...
///////////////////////////////////////////////////////////////////////////
//
//	US_PrintUnsigned() - Prints an uint32_t
//
///////////////////////////////////////////////////////////////////////////
void
...
///////////////////////////////////////////////////////////////////////////
//
//	US_PrintSigned() - Prints a signed int32_t
//
///////////////////////////////////////////////////////////////////////////
void
...
//
///////////////////////////////////////////////////////////////////////////
static void USL_CustomCursor(int16_t x,int16_t y,char *s,word cursor)
{
#ifdef __AMIGA__
#define status usl_status
#endif
...
//
///////////////////////////////////////////////////////////////////////////
boolean US_LineInput(int16_t x,int16_t y,char far *buf,char far *def,boolean escok,
